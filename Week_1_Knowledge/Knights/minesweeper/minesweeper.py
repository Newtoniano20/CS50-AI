...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in [-1, 0, 1]:
            for k in [-1, 0, 1]:
                new_cell = (a+i, b+k)
                if new_cell not in self.safes and new_cell[0] < self.height and new_cell[1] < self.width and new_cell[0] >= 0 and new_cell[1] >= 0:
        ...
        for sentence in self.knowledge:
            ...
            for mine in sentence.known_safes():
                if mine is not None:
                    new_safes.append(mine)
            ...
            for sentence2 in self.knowledge:
                if sentence1 != sentence2:
                    if sentence1.cells in sentence2.cells:
                        n_cells = set()
                        for _cell in sentence2.cells:
                            if _cell not in sentence1.cells:
                                n_cells.add(_cell)
                        n_sentence = Sentence(cells=n_cells, count=(sentence2.count-sentence1.count))
    ...
    def make_random_move(self):
        ...
        choice_y = int(random.random()*self.height)
        choice_x = int(random.random()*self.width)
